...
export const metadata: Metadata = createMetadata({
  title: "Parcours et expertises Cloud & DevOps",
  description:
    "Jules Royet, architecte Cloud et DevOps chez Orange, diplômé de l’ENSEIRB-MATMECA. Parcours, compétences et projets, de Bordeaux à Nice.",
  path: "/about",
});
