...
const cspHeader = `
  ...
  img-src 'self' blob: data: https://cdn.simpleicons.org https://svgl.app https://img.shields.io https://avatars.githubusercontent.com https://raw.githubusercontent.com;
  font-src 'self';
  object-src 'none';
  base-uri 'self';
  form-action 'self';
